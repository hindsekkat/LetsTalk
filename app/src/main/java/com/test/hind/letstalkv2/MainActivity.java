package com.test.hind.letstalkv2;
...
import com.test.hind.letstalkv2.data.StaticConfig;
import com.test.hind.letstalkv2.service.ServiceUtils;
import com.test.hind.letstalkv2.ui.FriendsFragment;
import com.test.hind.letstalkv2.ui.GroupFragment;
import com.test.hind.letstalkv2.ui.LoginActivity;
import com.test.hind.letstalkv2.ui.UserProfileFragment;
import com.test.hind.letstalkv2.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    //private static final int notifID = 3258;
...
//    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.about) {
            Toast.makeText(this, "Let's talk version 1.0", Toast.LENGTH_LONG).show();
            return true;
        }
