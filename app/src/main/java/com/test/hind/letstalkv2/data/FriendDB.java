package com.test.hind.letstalkv2.data;
...
import com.test.hind.letstalkv2.model.Friend;
import com.test.hind.letstalkv2.model.ListFriend;

// we'll work with friends and friendsList from the model
...
public final class FriendDB {
    ...
    public long addFriend(Friend friend) {
        ...
        /**/values.put(FeedEntry.COLUMN_NAME_SEXE, friend.sexe);
        /**/values.put(FeedEntry.COLUMN_NAME_USERAGE, friend.userage);
        /**/values.put(FeedEntry.COLUMN_NAME_PAYS, friend.pays);
        /**/values.put(FeedEntry.COLUMN_NAME_LANGUAGE, friend.language);
...
// you will actually use after this query.
        try {
            ...
            while (cursor.moveToNext()) {
                ...
                friend.sexe = cursor.getString(5);
                friend.language = cursor.getString(6);
                friend.pays = cursor.getString(7);
                friend.userage = cursor.getInt(8);
    ...
    public static class FeedEntry implements BaseColumns {
        ...
        static final String COLUMN_NAME_SEXE = "sexe";
        static final String COLUMN_NAME_USERAGE = "userage";
        static final String COLUMN_NAME_PAYS = "pays";
